...
export function Standard() {
  ...
  const [selectedBookAndChapter, setSelectedBookAndChapter] =
    useState<BookChapterSelection | null>(null);
    ...
    <div className="p-8 bg-gray-100 min-h-screen scrollbar-hidden">
      <div className="mb-6">
        ...
        <div className="p-10 text-5xl opacity-75">
          {selectedBookAndChapter
            ? `${books?.find((b) => b.id == selectedBookAndChapter.bookId)?.name} ${selectedBookAndChapter.chapter}`
            : "No Selection"}
        </div>
      </div>
