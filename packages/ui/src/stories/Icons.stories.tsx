...
export const AllIcons: Story = {
  render: () => (
    <div className="flex flex-col gap-8">
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-lg font-semibold">Magnifying Glass Icon</h2>
        <div className="flex gap-4 items-center">
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-lg font-semibold">Chevron Down Icon</h2>
        <div className="flex gap-4 items-center">
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-lg font-semibold">Chevron Up Icon</h2>
        <div className="flex gap-4 items-center">
